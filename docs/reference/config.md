...
- [Config](/confkit/api/confkit.html#Config) – Descriptor managing reading/writing typed values.

## Lifecycle / Initialization Helpers

- [Config.set_parser](/confkit/api/confkit.html#Config.set_parser)
- [Config.set_file](/confkit/api/confkit.html#Config.set_file)
- [Config.write](/confkit/api/confkit.html#Config.write)

## Runtime Flags

- [Config.validate_types](/confkit/api/confkit.html#Config.validate_types)
- [Config.write_on_edit](/confkit/api/confkit.html#Config.write_on_edit)

## Decorators

- [Config.set](/confkit/api/confkit.html#Config.set) – Always set a value before calling a function.
- [Config.default](/confkit/api/confkit.html#Config.default) – Set only when unset.
- [Config.with_setting](/confkit/api/confkit.html#Config.with_setting) – Inject an existing descriptor value as a kwarg.
- [Config.with_kwarg](/confkit/api/confkit.html#Config.with_kwarg) – (Named `with_kwarg` in code; often described as `with_kwarg`) inject by section/setting with optional rename & default.

## Internal Validation (Selected)

- [Config.validate_file](/confkit/api/confkit.html#Config.validate_file)
- [Config.validate_parser](/confkit/api/confkit.html#Config.validate_parser)
- [Config.validate_strict_type](/confkit/api/confkit.html#Config.validate_strict_type)
